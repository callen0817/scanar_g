...
PRODUCT_CAPABILITIES = {
    ...
    "scanar_c": ProductCapability("ScanAR C", has_rgb_camera=True, color_mode="natural", default_fps=60.0, default_resolution=(1280, 720), reconstruction_engine="lingbot", startup_services=["viture_driver", "lingbot_engine", "viture_hud"]),
    ...
    "scanar_s2": ProductCapability("ScanAR S2", has_rgb_camera=True, color_mode="natural", default_fps=60.0, default_resolution=(1920, 1080), reconstruction_engine="vins_fusion", startup_services=["oak_d_poe_driver", "dual_rtk_imu_driver", "vins_fusion_engine", "viture_hud"]),
